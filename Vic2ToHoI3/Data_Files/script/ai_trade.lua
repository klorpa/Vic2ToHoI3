...
function P.Trade_GetResources(voTag, voCountry, vbHumanSelling)
	...
	local laResouces = {
		...
		METAL = {
			Buffer = 1, 			-- Amount extra to keep above our needs
			...
			Multiplier = 1, 		-- (DO NOT OVERRIDE THIS IN COUNTRY FILES)
			TradeOBJ = "vMetal",	-- (DO NOT OVERRIDE THIS IN COUNTRY FILES)
			CGoodsPool = CGoodsPool._METAL_},	-- (DO NOT OVERRIDE THIS IN COUNTRY FILES)
		ENERGY = {
			Buffer = 5,
			BufferSaleCap = 600,
			BufferBuyCap = 80000,
